...
#warning "Please clean up extraneous sections from code merge!"
#undef EXTRANEOUS_SECTIONS_OUTPUT_START
#ifdef EXTRANEOUS_SECTIONS_OUTPUT_START
...
#endif // EXTRANEOUS_SECTIONS_OUTPUT_END
