...
/// @file /tasi/sve/dss/SumL3.h

#ifndef _TASI_SVE_DSS_SUML3_H_
#define _TASI_SVE_DSS_SUML3_H_
...
#include "libs/dss_level_2/SUM.h"
...
namespace tasi
{
    namespace sve
    {
        namespace dss
        {
            ...
            /// Universally unique identifier of model SumL3.
            /// @return Universally Unique Identifier of SumL3.
            static const ::Smp::Mdk::Uuid Uuid_SumL3("79d8c842-a2b6-3e74-8751-88f7756c2a1f");
                  ...
                  virtual public ::Smp::Mdk::Management::EntryPointPublisher
            {
                ...
                // -----------------------------------------------------------------------------
                    ...
                    ::Smp::IEntryPoint* UpdateSum; // %RELAX<dmaccess> SMP2 EntryPoint is public
                ...
                // -----------------------------------------------------------------------------
// --OPENING ELEMENT--::tasi::sve::dss::SumL3/SumL3::Extra_Public_Fields--
                // MARKER: EXTRA FIELD DECLARATIONS: START
                // INSERT HERE EXTRA FIELD DECLARATIONS
    				SUM sumobj = SUM("SUM",MAX_ADD);
                // MARKER: EXTRA FIELD DECLARATIONS: END
// --CLOSING ELEMENT--::tasi::sve::dss::SumL3/SumL3::Extra_Public_Fields--

// --OPENING ELEMENT--::tasi::sve::dss::SumL3/SumL3::Extra_Public_Methods--
                // MARKER: EXTRA METHOD DECLARATIONS: START
                // INSERT HERE EXTRA METHOD DECLARATIONS
                // MARKER: EXTRA METHOD DECLARATIONS: END
// --CLOSING ELEMENT--::tasi::sve::dss::SumL3/SumL3::Extra_Public_Methods--
                ...
                // -----------------------------------------------------------------------------
// --OPENING ELEMENT--::tasi::sve::dss::SumL3/SumL3::Extra_Protected_Fields--
                // MARKER: EXTRA FIELD DECLARATIONS: START
                // INSERT HERE EXTRA FIELD DECLARATIONS
                // MARKER: EXTRA FIELD DECLARATIONS: END
// --CLOSING ELEMENT--::tasi::sve::dss::SumL3/SumL3::Extra_Protected_Fields--

// --OPENING ELEMENT--::tasi::sve::dss::SumL3/SumL3::Extra_Protected_Methods--
                // MARKER: EXTRA METHOD DECLARATIONS: START
                // INSERT HERE EXTRA METHOD DECLARATIONS
                // MARKER: EXTRA METHOD DECLARATIONS: END
// --CLOSING ELEMENT--::tasi::sve::dss::SumL3/SumL3::Extra_Protected_Methods--
                ...
                // -----------------------------------------------------------------------------
                    ...
                    ::Smp::Int32 sumProgressiveID;    

// --OPENING ELEMENT--::tasi::sve::dss::SumL3/SumL3::Copy/Assignment--
                // -----------------------------------------------------------------------------
                ...
                // CUSTOMISE COPY / ASSIGNMENT DECLARATION
                    ...
                    SumL3& operator =(const SumL3&);
                // MARKER: COPY / ASSIGNMENT DECLARATION: END
// --CLOSING ELEMENT--::tasi::sve::dss::SumL3/SumL3::Copy/Assignment--
                ...
                // -----------------------------------------------------------------------------
                    ...
                    static ::Smp::Mdk::Management::RequestContainer<SumL3>::Map requestHandlers;

                // -----------------------------------------------------------------------------
                // ------------------------- Custom private declarations -----------------------
                // -----------------------------------------------------------------------------
// --OPENING ELEMENT--::tasi::sve::dss::SumL3/SumL3::Extra_Private_Fields--
                // MARKER: EXTRA FIELD DECLARATIONS: START
                // INSERT HERE EXTRA FIELD DECLARATIONS
                // MARKER: EXTRA FIELD DECLARATIONS: END
// --CLOSING ELEMENT--::tasi::sve::dss::SumL3/SumL3::Extra_Private_Fields--

// --OPENING ELEMENT--::tasi::sve::dss::SumL3/SumL3::Extra_Private_Methods--
                // MARKER: EXTRA METHOD DECLARATIONS: START
                // INSERT HERE EXTRA METHOD DECLARATIONS
                // MARKER: EXTRA METHOD DECLARATIONS: END
// --CLOSING ELEMENT--::tasi::sve::dss::SumL3/SumL3::Extra_Private_Methods--
            };
...
// --OPENING ELEMENT--::tasi::sve::dss::SumL3/SumL3::PopulateRequestHandlers--
            /// It populates the static map of request handler to implement the invoke function.
            /// The map will be populated recursively first with the class handlers and then
            /// with all parent handlers. This way specialised handlers take precedence over
            /// parent class ones.
            ...
            /// @param handlers the map to be populated.
            template <typename _Type>
            void SumL3::PopulateRequestHandlers(
            _Type* bluePrint,
            typename ::Smp::Mdk::Management::RequestContainer<_Type>::Map& handlers)
            {
                ...
                Help::template AddIfMissing< void>(handlers, "UpdateSum", ::Smp::ST_None, &SumL3::_UpdateSum);

            }
// --CLOSING ELEMENT--::tasi::sve::dss::SumL3/SumL3::PopulateRequestHandlers--

// --OPENING ELEMENT--::tasi::sve::dss::SumL3/SumL3::After_Declaration--
            // MARKER: EXTRA METHOD DECLARATIONS: START
            // INSERT HERE EXTRA METHOD DECLARATIONS
            // MARKER: EXTRA METHOD DECLARATIONS: END
// --CLOSING ELEMENT--::tasi::sve::dss::SumL3/SumL3::After_Declaration--
